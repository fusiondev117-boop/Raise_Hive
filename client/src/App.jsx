            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
              ...
              <div className="col-span-1 md:col-span-2">
                ...
                <div className="flex gap-4 mt-6">
                  <a
                    ...
                    className="w-10 h-10 rounded-full bg-gray-100 dark:bg-dark-800 flex items-center justify-center hover:bg-primary-500 hover:text-white dark:hover:bg-primary-500 transition-smooth hover-scale group"
                  >
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li><Link to="/" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 text-sm transition-smooth hover-scale-sm inline-block">Explore Projects</Link></li>
                  <li><Link to="/create-campaign" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 text-sm transition-smooth hover-scale-sm inline-block">Start Campaign</Link></li>
                  <li><Link to="/HowItWorks" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 text-sm transition-smooth hover-scale-sm inline-block">How It Works</Link></li>
                  <li><Link to="/about" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 text-sm transition-smooth hover-scale-sm inline-block">About Us</Link></li>
                </ul>
              </div>
