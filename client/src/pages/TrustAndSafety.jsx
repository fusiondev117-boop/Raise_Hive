        ...
        <>
            <div className="flex flex-wrap">
                <div className="w-full md:w-2/3 px-10">
                    ...
                    <p className="mt-4 text-lg text-justify">Raise Hive's mission is to empower people to unite around ideas that matter to them and together make those ideas come to life. Providing a safe, secure, and trusted platform is an essential part of achieving that mission. We want to provide our backers with the information that they need in order to feel confident supporting innovative products as they make their way all the way from concept to market. It's a global collaboration built on transparency, trust, and a passion for those “a-ha!” moments.</p>
                </div>
