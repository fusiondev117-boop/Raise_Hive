        ...
        <>
            <div className="px-4 py-12 lg:px-24">
                ...
                <p className="text-lg sm:text-xl text-justify lg:text-xl">
                    Welcome to Raise Hive! By using this Site and the Services, in addition to any Additional Policies applicable to any particular features, Content and functionality of the Services (incorporated into the Terms by reference), offered by Raise Hive, Inc., Users agree to be bound by these Terms. 
                </p>
            </div>
            ...
            <div className='lg:px-24 px-4'>
                ...
                <ol className='list-decimal text-xl ml-5'>
                    <li className='pb-4'>
                        <a href='#' className='text-[#808191] text-xl' onClick={(event) => handleLinkClick(event, '1')}>What is Raise Hive?</a>
                    </li>
                    <li className='pb-4'>
                    ...
                    <li className='pb-4'>
                        <a href='#' className='text-[#808191] text-xl' onClick={(event) => handleLinkClick(event, '4')}>Raise Hive's Role</a>
                    </li>
                    <li className='pb-4'>
            ...
            <div className='lg:px-24 px-4 py-8' id='3'>
                ...
                <p className='text-lg text-justify'>When you create a Campaign on the Site and ask for Contributions, you understand that you are entering into separate legal agreements with both Raise Hive and with your Contributors, and the following rules apply (in addition to all other Terms and Additional Policies).</p>
                <ol className="pt-8">
            ...
            <div className='lg:px-24 px-4 py-8' id='4'>
                <h1 className="text-2xl font-semibold text-left"> Raise Hive's Role</h1>
                <ol className="pt-8">
                    <li className='text-lg text-justify pb-8'><span className="underline font-bold"> Platform Facilitation:</span> Raise Hive serves as a facilitator for crowdfunding campaigns, providing a user-friendly platform for project creators to showcase their ideas and receive support from backers.</li>
                    <li className='text-lg text-justify pb-8'><span className="underline font-bold"> Transparency:</span> Raise Hive prioritizes transparency by leveraging blockchain technology to ensure that all transactions and interactions on the platform are recorded immutably on the blockchain. This enhances accountability and trust between project creators and backers.</li>
                    <li className='text-lg text-justify pb-8'><span className="underline font-bold"> Smart Contract Implementation:</span> Raise Hive utilizes smart contracts to automate fund disbursement and ensure that funds are released to project creators only when predefined milestones are met. This minimizes the risk of fraud and mismanagement of funds.</li>
                    <li className='text-lg text-justify pb-8'><span className="underline font-bold"> Community Engagement:</span> Raise Hive fosters a vibrant community of creators and backers, encouraging collaboration, feedback, and support. Through features such as commenting, sharing, and social media integration, Raise Hive facilitates meaningful interactions between project creators and backers.</li>
                    <li className='text-lg text-justify pb-8'><span className="underline font-bold"> Dispute Resolution:</span> In the event of disputes between project creators and backers, Raise Hive provides mechanisms for dispute resolution, including mediation and arbitration services. This helps to mitigate conflicts and ensure a positive crowdfunding experience for all parties involved.</li>
                    <li className='text-lg text-justify pb-8'><span className="underline font-bold"> Educational Resources:</span> Raise Hive offers educational resources and guidance to help project creators launch successful campaigns. This includes tutorials, best practices, and tips for creating compelling campaigns and engaging with backers effectively.</li>
                    <li className='text-lg text-justify pb-8'><span className="underline font-bold"> Continuous Improvement:</span> Raise Hive is committed to continuous improvement and innovation. By soliciting feedback from users and staying abreast of industry trends and developments, Raise Hive aims to evolve and adapt to meet the changing needs of the crowdfunding community.</li>
                </ol>
            </div>
            ...
            <div className='lg:px-24 px-4 py-8' id='5'>
                ...
                <ol className="pt-8">
                    <li className='text-lg text-justify pb-8'><span className="underline font-bold"> Raise Hive Intellectual Property:</span> Raise Hive's Services, Content and Marks, are legally protected in a number of ways, including pursuant to copyright, trademark, service marks, patent, trade secrets, and other U.S. and international intellectual-property laws. You agree to respect all copyright and other legal notices, information, and restrictions contained in any Raise Hive Content, Services, or Marks accessed through the Site or the Services. You agree not to change, translate, or otherwise create derivative works of the Services.</li>
                    <li className='text-lg text-justify pb-8'><span className="underline font-bold"> Limited User Rights; License to Raise Hive Content:</span> Raise Hive grants you a limited license (that is temporary, non-exclusive, non-sublicensable, and non-transferrable) to access and use User Content and Raise Hive Content solely for use of the Services in accordance with these Terms. You may not reproduce, redistribute, transmit, assign, sell, broadcast, rent, share, lend, modify, adapt, edit, create derivative works of, license, or otherwise transfer or use any User Content or Raise Hive Content unless We give you express written permission to do so. We reserve the right to revoke this limited license to access and use User Content and Raise Hive Content at any time and in our sole discretion.</li>
                </ol>
            </div>
            ...
            <div className='lg:px-24 px-4 py-8' id='6'>
                ...
                <ol className="pt-8">
                    ...
                    <li className='text-lg text-justify pb-8'><span className="underline font-bold"> You have all legal rights to your User Content:</span> You represent and warrant that: (1) you have all licenses, rights, consents, and permissions necessary to grant the rights set forth in these Terms to Raise Hive with respect to your User Content; (2) your User Content does not and will not infringe any third party's intellectual property rights, proprietary rights, privacy rights, confidentiality, rights of publicity or otherwise violate these Terms or applicable law; and (3) Raise Hive does not need to obtain any licenses, rights, consents, or permissions from, or make any payments to, any third party for any use of your User Content, or have any liability to a User or any other party as a result of Our use or exploitation of your User Content.</li>
                </ol>
            </div>
            ...
            <div className='lg:px-24 px-4 py-8' id='8'>
                ...
                <p className='text-lg pt-4 text-justify'>By accessing and using the payment services provided by Raise Hive, you agree to comply with the following terms of use. These terms govern all financial transactions and related services within our crowdfunding platform.</p>
                <ol className="pt-8">
                    <li className='text-lg text-justify pb-8'><span className="font-bold"> Authorized Payment Methods: </span>Raise Hive accepts various payment methods, including electronic wallets, and cryptocurrencies such as Ethereum. You are responsible for ensuring that your payment method is valid and authorized for use on the platform.</li>
                    <li className='text-lg text-justify pb-8'><span className="font-bold"> Transaction Fees: </span>Raise Hive charges transaction fees for the use of its payment services. The exact fee amount may vary based on the payment method, campaign type, and other factors. Fees will be disclosed to you before completing a transaction, and you agree to pay all applicable fees.</li>
                    <li className='text-lg text-justify pb-8'><span className="font-bold"> Secure Payment Processing: </span>Raise Hive takes security seriously and uses encryption and other security measures to protect payment transactions. However, you are responsible for safeguarding your payment information, including card details and digital wallet keys. Raise Hive is not liable for unauthorized transactions resulting from your failure to maintain proper security.</li>
                    <li className='text-lg text-justify pb-8'><span className="font-bold"> Fund Disbursement: </span>Funds raised through Raise Hive's campaigns are disbursed to campaign owners based on predefined conditions or milestones as outlined in the campaign details. Smart contracts used to automate fund disbursement. Once funds are disbursed, Raise Hive has no further responsibility for their use or management.</li>
                    <li className='text-lg text-justify pb-8'><span className="font-bold"> Refunds and Cancellations: </span>Refunds and cancellations are subject to the policies outlined by Raise Hive and the individual campaign. Refund requests must be made within the designated timeframe, and approval depends on specific circumstances, such as campaign cancellation or failure to meet funding goals. Refund processing times may vary, and transaction fees may not be refundable.</li>
                    <li className='text-lg text-justify pb-8'><span className="font-bold"> Dispute Resolution: </span>In the event of a payment-related dispute, you agree to attempt resolution through Raise Hive's customer support. If the dispute cannot be resolved, Raise Hive may offer additional dispute resolution mechanisms, including mediation or arbitration. Legal action should be considered a last resort.</li>
                    <li className='text-lg text-justify pb-8'><span className="font-bold"> Modifications to Payment Services: </span>Raise Hive reserves the right to modify or discontinue its payment services at any time without prior notice. Significant changes to terms or fee structures will be communicated to users, and continued use of the services after such changes indicates acceptance.</li>
                </ol>
            </div>
            ...
            <div className='lg:px-24 px-4 py-8' id='13'>
                ...
                <ol className="pt-8">
                    ...
                    <li className='text-lg text-justify pb-8'><span className="font-bold"> "Raise Hive, " "We, " "Our, "</span> or <span className=" font-bold">"Us"</span> refers to Raise Hive, Inc., a Delaware corporation, together with its parents, subsidiaries, affiliates, agents, representatives, consultants, employees, officers, and directors;</li>
                    <li className='text-lg text-justify pb-8'><span className="font-bold"> "Raise Hive Content"</span> refers to Content provided by Raise Hive to Users in connection with the Services, including, without limitation, the software, the products and the site;</li>
                    ...
                    <li className='text-lg text-justify pb-8'><span className="font-bold"> "Marks"</span> refers to the trademarks, service marks, and logos used and displayed throughout the Services or in any or in any Raise Hive Content;</li>
                    ...
                    <li className='text-lg text-justify pb-8'><span className="font-bold"> "Privacy Policy"</span> refers to Raise Hive's Privacy Policy.</li>
                    ...
                    <li className='text-lg text-justify pb-8'><span className="font-bold"> "Site"</span> refers to the Raise Hive website(s);</li>
                    <li className='text-lg text-justify pb-8'><span className="font-bold"> "Terms"</span> or <span className=" font-bold">"Terms of Use" </span> refers the Terms of Use, Additional Policies, Raise Hive's Privacy Policy, all applicable laws, and all conditions or policies referenced here;</li>
            ...
            <div className='lg:px-24 px-4 py-8' id='14'>
                ...
                <p className='text-lg pt-4 text-justify'>These Terms are the entire agreement between You and Raise Hive with respect to the Services. They supersede all other communications and proposals (whether oral, written, or electronic) between you and Raise Hive with respect to the Services and govern our relationship. If any provision of these Terms are deemed invalid by a court of competent jurisdiction, the invalidity of such provision shall not affect the validity of the remaining provisions of this Agreement, which shall remain in full force and effect. Raise Hive's failure to assert any right or provision under this Agreement shall not constitute a waiver of such right or provision.</p>
            </div>

            <div className='lg:px-24 px-4 py-8' id='15'>
                <h1 className="text-2xl font-semibold text-left"> Miscellaneous</h1>
                <p className='text-lg pt-4 text-justify'>We may modify or discontinue the Services at any time, in our sole discretion. You agree that, except as otherwise expressly provided in these Terms, there shall be no third-party beneficiaries to these Terms. No waiver of any provision of these Terms shall be deemed a further or continuing waiver of such term or any other term, and Raise Hive's failure to assert any right or provision under these Terms shall not constitute a waiver of such right or provision. You agree that regardless of any statute or law to the contrary, any claim arising out of or related to the Services must commence within one (1) year after the cause of action accrues. Otherwise, such cause of action is permanently barred.</p>
            </div>
